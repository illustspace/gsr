/**
 * @file copied from https://github.com/visgl/react-map-gl/blob/7.0-release/examples/geocoder/src/geocoder-control.tsx
 */
...
> & {
  ...
  onResult?: (e: { result: MapboxGeoJSONFeature }) => void;
